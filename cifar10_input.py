...
IMAGE_SIZE = 36 # fer2013 48x48 --> 36x36 crop

# Global constants describing the CIFAR-10 data set.
NUM_CLASSES = 7 # fer2013 7 calsses  0=Angry, 1=Disgust, 2=Fear, 3=Happy, 4=Sad, 5=Surprise, 6=Neutral
...
def distorted_inputs(data_dir, batch_size):
  ...
  Returns:
    ...
    labels: Labels. 1D tensor of [batch_size] size.
  """
  filenames = [os.path.join(data_dir, 'fer2013train.bin') ]
